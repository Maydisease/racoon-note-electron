...
if (process.platform.indexOf('win') === 0) {
	node_lib = 'node_sqlite3.win.node';
} else if (process.platform === 'darwin') {
	node_lib = 'node_sqlite3.mac.node';
} else {
	console.log('current platform is not supported yet');
}

var binding_path = path.join(__dirname, node_lib);
